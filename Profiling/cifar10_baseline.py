...
imgDir = '/export/hdd/scratch/dataset/cifar_10_images/train'
test_imgDir = '/export/hdd/scratch/dataset/cifar_10_images/test'
batch_size = 64
batch_size_test = 100
...
train_label = np.load(
    "/export/hdd/scratch/dataset/cifar_10_images/labels/cifar_10_labels.npy")
test_label = np.load(
    "/export/hdd/scratch/dataset/cifar_10_images/labels/cifar_10_labels_test.npy")
...
transform_train = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize((0.48947954, 0.48043759, 0.4465),
                         (0.24513403, 0.24289503, 0.25973428)),
])
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/cifar10_dynamic_prune.pth')
        best_acc = acc
