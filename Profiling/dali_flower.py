...
imgDir = '/export/hdd/scratch/dataset/102flowers/train_GPU_decode/image_list.txt'
#test_imgDir = '/export/hdd/scratch/dataset/mini_imagenet_split/val'


#test_label = np.load("/export/hdd/scratch/hchen799/INR/102flowers/val_label.npy")
test_imgDir = '/export/hdd/scratch/hchen799/INR/102flowers/val'
...
def get_dali_pipeline():
    ...
    images = fn.rotate(images, angle=45)
...
test_label = np.load(
    "/export/hdd/scratch/hchen799/INR/102flowers/val_label.npy")
test_label = test_label - 1
