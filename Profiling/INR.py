...
imgpath = os.listdir("/export/hdd/scratch/dataset/imagenet/train/n01694178/")
time_start = time.time()
for i in range(64):

    img = cv2.imread(
        "/export/hdd/scratch/dataset/imagenet/train/n01694178/%s" %
        (imgpath[i + 1]))
