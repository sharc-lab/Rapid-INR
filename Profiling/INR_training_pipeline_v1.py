...
def decode(batch_idx, coordinates, linear_0_weight, linear_0_bias,
    ...
    output5 = output5.permute(0, 3, 1, 2)
    # if batch_idx > 0:
    #     conn_send.send(output5)
    return output5
...
def train(epoch, coordinates, linear_0_weight, linear_0_bias, linear_1_weight,
    ...
    conn_send, conn_recv = mp.Pipe()
    # output = decode(0, coordinates, linear_0_weight, linear_0_bias,
    #                 linear_1_weight, linear_1_bias, linear_2_weight,
    #                 linear_2_bias, linear_3_weight, linear_3_bias,
    #                 linear_4_weight, linear_4_bias, conn_send)
    next_output = 0
    for batch_idx in range(num_inter):
        ...
        #                args=(batch_idx + 1, coordinates, linear_0_weight,
        #                      linear_0_bias, linear_1_weight, linear_1_bias,
        #                      linear_2_weight, linear_2_bias, linear_3_weight,
        #                      linear_3_bias, linear_4_weight, linear_4_bias,
        #                      conn_send))
        # p.start()
...
if __name__ == "__main__":
    ...
    linear_0_weight = torch.zeros(num_images * num_inter, 2, hidden_dimension)
    linear_0_bias = torch.zeros(num_images * num_inter, hidden_dimension)
    linear_1_weight = torch.zeros(num_images * num_inter, hidden_dimension,
                                  hidden_dimension)
    linear_1_bias = torch.zeros(num_images * num_inter, hidden_dimension)
    linear_2_weight = torch.zeros(num_images * num_inter, hidden_dimension,
                                  hidden_dimension)
    linear_2_bias = torch.zeros(num_images * num_inter, hidden_dimension)
    linear_3_weight = torch.zeros(num_images * num_inter, hidden_dimension,
                                  hidden_dimension)
    linear_3_bias = torch.zeros(num_images * num_inter, hidden_dimension)
    linear_4_weight = torch.zeros(num_images * num_inter, hidden_dimension, 3)
    linear_4_bias = torch.zeros(num_images * num_inter, 3)
