...
imgDir = '/usr/scratch/dataset/cifar_10_images/train_GPU_decode/train/image_list.txt'
test_imgDir = '/usr/scratch/dataset/cifar_10_images/test'
batch_size = 64
batch_size_test = 100
...
def get_dali_pipeline():
    ...
    images = fn.resize(images, resize_x=36, resize_y=36)
    ...
    images = fn.crop_mirror_normalize(
        ...
        crop_h=32,
        crop_w=32,
        mean=[0.48947954 * 255, 0.48043759 * 255, 0.4465 * 255],
        std=[0.24513403 * 255, 0.24289503 * 255, 0.25973428 * 255],
...
#test_label = np.load("/export/hdd/scratch/dataset/mini_imagenet_split/labels/val_label.npy")

test_label = np.load(
    "/usr/scratch/dataset/cifar_10_images/labels/cifar_10_labels_test.npy")
