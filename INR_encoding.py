...
parser.add_argument("-dp", "--dataset_path", help="The path of the dataset", default=f"/export/hdd/scratch/dataset/imagenet/train/n01440764")
parser.add_argument("-ld", "--logdir", help="Path to save logs", default=f"./ImageNet_logfiles")
parser.add_argument("-wd", "--INR_weights_dir", help="Path to save INR weights", default=f"./weights_ImageNet")
parser.add_argument("-ri", "--resized_image", help="Path to save resized images", default=f"./resizeimg_in")
parser.add_argument("-rconi", "--reconstructed_image", help="Path to save reconstructed images", default=f"./reconimages_ImageNet/trial")
parser.add_argument("-ra", "--reconstructed_image_array", help="Path to save reconstructed images array", default=f"./ImageNet_array")
...
parser.add_argument("-nit", "--num_iters", help="Number of iterations to train for", type=int, default=10000)
parser.add_argument("-nim", "--num_images", help="Number of images to train on", type=int, default=10)
